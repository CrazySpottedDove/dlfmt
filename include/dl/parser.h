...
private:
     ...
     * @param comma_list
     */
    void exprlist(std::vector<std::unique_ptr<AstNode>>& expr_list,
     ...
     */
    std::unique_ptr<AstNode> prefixexpr();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> tableexpr();
     ...
     * @param after
     */
    void blockbody(std::string_view terminator, std::unique_ptr<AstNode>& body, Token*& after);
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> funcdecl_anonymous();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<FunctionStat> funcdecl_named();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> functionargs();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> primaryexpr();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> simpleexpr();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> subexpr(const size_t priority_limit);
     ...
     * @return std::unique_ptr<AstNode>
     */
    inline std::unique_ptr<AstNode> expr();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> exprstat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> whilestat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> forstat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> repeatstat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> localdecl();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> retstat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> breakstat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> gotostat();

    /**
     * @brief 解析 label 语句
     *
     */
    std::unique_ptr<AstNode> labelstat();
     ...
     * @return std::unique_ptr<AstNode>
     */
    std::unique_ptr<AstNode> statement(bool& is_last);
